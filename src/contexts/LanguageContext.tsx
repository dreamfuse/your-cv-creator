...
const translations = {
  en: {
    ...
    "skills.currentlyLearningDesc": "I am actively learning to expand my expertise in these areas",
    ...
    "skills.currentlyLearningDesc": "Opiskelen aktiivisesti laajentaakseni osaamistani näillä alueilla",
